...
public static class Arch
{
    ...
    public static readonly UnitArchetype Mage = new(
        "Mage", Role.AoE, MaxHp: 24, Damage: 11, AttackRange: 8f, MoveSpeed: 1.9f,
        AttackCooldown: 1.9f, BodyScale: 1.0f, Color: new Color(0.6f, 0.35f, 0.85f),
        DetectionRange: 18f, SplashRadius: 2.6f);
    ...
    public static readonly UnitArchetype Boss = new(
        ...
        CollisionRadius: 1.7f, DetectionRange: 24f);
}
